...
Trying this out instead of magit-gh-pulls
...
**** CANCELED magit-gh-pulls

[[https://github.com/sigma/magit-gh-pulls][magit-gh-pulls]] - Magit extension for dealing with GitHub pull
requests.

Have to install marshall from melpa-stable to avoid missing function
errors -[[ https://github.com/sigma/magit-gh-pulls/issues/117][issue 117]]

#+BEGIN_SRC emacs-lisp :name marshal
(use-package marshal
  :ensure t
  :pin melpa-stable)
#+END_SRC

#+begin_src emacs-lisp :name magit-gh-pulls
